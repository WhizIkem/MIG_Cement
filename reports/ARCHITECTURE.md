...
- `src/pipeline_gb.py`: Builds forecasts, scenario simulations, reorder logic, turnover, coverage days, and safety stock metrics using the feature-engineered Gradient Boosting planning model.
...
Baseline/model narrative in the dashboard should present Random Forest as the baseline and Gradient Boosting as the improved planning model.
